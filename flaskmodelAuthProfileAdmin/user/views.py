...
from user.forms import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
    ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
from auth.models import User, Photo, Collect
...
def index(username):
   ...
   # pagination = Photo.query.with_parent(user).order_by(Photo.timestamp.desc()).paginate(page, per_page)
    ...
    return render_template('user/index.html', user=user, pagination=None, photos=None)
