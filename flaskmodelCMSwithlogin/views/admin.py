from flask import Blueprint,url_for,redirect,flash,render_template,request,current_app,send_from_directory
...
def manage_post():
    ...
    pagination=Post.query.order_by(Post.timestamp.desc())\
        .paginate(page,per_page=current_app.config['FLASKBLOG_POST_PER_PAGE'])
